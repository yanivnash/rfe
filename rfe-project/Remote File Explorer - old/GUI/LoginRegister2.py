...
def choose_mode(choose_frame, control_pic, be_controlled_pic):#, old_frame):
    ...
    def be_controlled_bttn():
        ...
        mode = 'be_controlled'
        choose_frame.quit()
    # main_title = tkinter.Label(choose_frame, text='Remote File Explorer - old', font=('Eras Bold ITC', 35, 'bold'), fg='gray20', bg=label_bg_color)
    main_title = tkinter.Label(choose_frame, text='Choose an action for this PC:', font=('Eras Bold ITC', main_window2.calc_width(35), 'bold'), fg='gray20', bg=label_bg_color)
    ...
    control_label = tkinter.Label(frame, text='CONTROL', font=('Eras Bold ITC', main_window2.calc_width(20), 'bold'), fg='gray20', bg='white')
    ...
    control_label = tkinter.Label(frame, text='BE CONTROLLED', font=('Eras Bold ITC', main_window2.calc_height(20), 'bold'), fg='gray20', bg='white')
...
def login_to_ssh_client(ip_frame, ip_dict):
    ...
    main_title = tkinter.Label(ip_frame, text='Choose an IP address to connect to:', font=('Eras Bold ITC', main_window2.calc_width(35), 'bold'), fg='gray20', bg=label_bg_color)
    ...
    def try_connect(host, username):
        ...
        #     password = simpledialog.askstring('Enter password', f'Enter the password to {host}:')
            ...
            if ssh == "wrong password":
                ...
                tkinter.messagebox.showerror(title="Couldn't connect", message=f"Couldn't connect to {host}\nPlease make sure that the computer is connected to the internet, has Remote File Explorer - old open in the 'Be Controlled' screen and try again")
            elif ssh == "timeout":
                tkinter.messagebox.showerror(title="Couldn't connect", message=f"Couldn't connect to {host}\nPlease make sure the password is correct that the computer is connected to the internet, has Remote File Explorer - old open in the 'Be Controlled' screen and try again")
            else:
                sftp = ssh.open_sftp()
                if check_var.get() == 1:
    ...
    def create_enter_frame():
        ...
        ip_error_title = tkinter.Label(enter_frame, text='Please enter an ip', font=('Eras Bold ITC', main_window2.calc_width(10)), fg='red', bg='white')
        ip_error_title.place(x=main_window2.calc_width(50), y=main_window2.calc_height(110), width=main_window2.calc_width(500))
        username_error_title = tkinter.Label(enter_frame, text='Please enter a username', font=('Eras Bold ITC', main_window2.calc_width(10)), fg='red', bg='white')
        username_error_title.place(x=main_window2.calc_width(50), y=main_window2.calc_height(215), width=main_window2.calc_width(500))
        ip_error_title.place_forget()
        username_error_title.place_forget()

        enter_ip_title = tkinter.Label(enter_frame, text='IP:', font=('Eras Bold ITC', main_window2.calc_width(20), 'bold'), fg='gray20', bg='white').place(x=main_window2.calc_width(285), y=main_window2.calc_height(35))
        enter_ip = tkinter.Entry(enter_frame, font=('Eras Bold ITC', main_window2.calc_width(15)), fg='gray20', bg='white', justify='center')
        ...
        enter_username_title = tkinter.Label(enter_frame, text='Username:', font=('Eras Bold ITC', main_window2.calc_width(20), 'bold'), fg='gray20', bg='white').place(x=main_window2.calc_width(225), y=main_window2.calc_height(140))  # (x=225, y=140)
        enter_username = tkinter.Entry(enter_frame, font=('Eras Bold ITC', main_window2.calc_width(15)), fg='gray20', bg='white', justify='center')
        ...
        save_to_acc = tkinter.Checkbutton(enter_frame, cursor='hand2', text="Save this PC's info to your account for future connections", fg='gray20', bg=buttons_bg_color, font=('Eras Bold ITC', main_window2.calc_width(10)), onvalue=1, offvalue=0, variable=check_var)
        save_to_acc.place(x=main_window2.calc_width(105), y=main_window2.calc_height(245))

        connect_button = tkinter.Button(enter_frame, text='Connect', cursor='hand2', font=('Eras Bold ITC', main_window2.calc_width(15)), fg='gray20', bg=buttons_bg_color, command=check_ip)
    ...
    show_enter_frame_btn = tkinter.Button(frame, command=create_enter_frame, image=enter_ip_pic, cursor='hand2', bg=buttons_bg_color, compound=tkinter.BOTTOM, text='Enter an IP', font=('Eras Bold ITC', main_window2.calc_width(10)))
    ...
    for key, value in ip_dict.items():
        ip_butns_dict[f'{key}-{value}'] = tkinter.Button(scrollable_frame, bd=0, text=f'{value} - {key}', cursor='hand2', font=('Eras Bold ITC', main_window2.calc_width(12)), anchor=tkinter.CENTER, fg='gray20', bg=buttons_bg_color)
    ...
    canvas.create_window((0, 0), window=scrollable_frame, anchor=tkinter.CENTER, width=main_window2.calc_width(610), height=main_window2.calc_height(392))
...
def set_be_controlled(be_controlled_frame):
    ...
    def run_power_shell(cmnd):
        if cmnd.__contains__("Add-WindowsCapability -Online -Name OpenSSH.Server~~~~0.0.1.0"):
            ...
            try:
                ...
                loading_label = tkinter.Label(frame, text='Installing SSH Service...', font=('Eras Bold ITC', main_window2.calc_width(20)), bg='white')
            ...
            try:
                shell.ShellExecuteEx(lpVerb='runas', lpFile='powershell.exe', lpParameters='/c ' + cmnd)
                loading_label = tkinter.Label(frame, text='Starting SSH Service...', font=('Eras Bold ITC', main_window2.calc_width(20)), bg='white')
                loading_label.place(x=0, y=0, width=610, height=392)
            ...
            try:
                shell.ShellExecuteEx(lpVerb='runas', lpFile='powershell.exe', lpParameters='/c ' + cmnd)
                loading_label = tkinter.Label(frame, text='Stopping SSH Service...', font=('Eras Bold ITC', main_window2.calc_width(20)), bg='white')
                loading_label.place(x=0, y=0, width=610, height=392)
                loading_label.after(5000, recheck_sshd)
                return 'DONE'
            except pywintypes.error:
    ...
    main_title = tkinter.Label(be_controlled_frame, text='Be Controlled:', font=('Eras Bold ITC', main_window2.calc_width(35), 'bold'), fg='gray20', bg=label_bg_color)
    ...
    refresh_bttn = tkinter.Button(frame, text='Recheck\nConnection', font=('Eras Bold ITC', main_window2.calc_width(10), 'bold'), command=recheck_sshd, compound=tkinter.TOP, justify=tkinter.CENTER, image=refresh_pic, bg=buttons_bg_color)
    refresh_bttn.place(x=10, y=10)
    subtitle = tkinter.Label(frame, font=('Eras Bold ITC', main_window2.calc_width(18), 'bold'), fg='gray20', bg='white')
    ...
    mark_label = tkinter.Label(frame, font=('Eras Bold ITC', main_window2.calc_width(18), 'bold'), compound=tkinter.LEFT, justify=tkinter.CENTER, bg='white', padx=20)
    if sshd_status == 'ON':
        ...
        off_bttn = tkinter.Button(frame, text='Stop SSH Service', cursor='hand2', font=('Eras Bold ITC', main_window2.calc_width(15)), bg='brown1', command=lambda: run_power_shell(off_cmnd))  # 'firebrick1/2 / red/red2
        off_bttn.place(x=200, y=310)
        # off_bttn.place(x=200, y=340)  # place like that if email button is placed

    elif sshd_status == 'OFF':
        start_button = tkinter.Button(frame, text='Start SSH Service', cursor='hand2', font=('Eras Bold ITC', main_window2.calc_width(15)), bg='dodger blue', command=lambda: run_power_shell(on_cmnd))
        ...
        start_button = tkinter.Button(frame, text='Install & Start SSH Service', cursor='hand2', font=('Eras Bold ITC', main_window2.calc_width(15)), bg='dodger blue', command=lambda: run_power_shell(install_and_on_cmnd))
...
def start_login_window(main_frame):
    ...
    root.title('Remote File Explorer - old - Login')
    def submit():
    ...
    email_error_title = tkinter.Label(login_frame, text='Please enter your email', font=('Eras Bold ITC', main_window2.calc_width(10)), fg='red', bg='white')
    email_error_title.place(x=main_window2.calc_width(55), y=main_window2.calc_height(110), width=main_window2.calc_width(500))  # (x=55, y=110, width=500)
    pass_error_title = tkinter.Label(login_frame, text='Please enter your password', font=('Eras Bold ITC', main_window2.calc_width(10)), fg='red', bg='white')
    pass_error_title.place(x=main_window2.calc_width(55), y=main_window2.calc_height(215), width=main_window2.calc_width(500))  # (x=55, y=215, width=500)
    email_error_title.place_forget()
    pass_error_title.place_forget()

    main_title = tkinter.Label(main_frame, text='Remote File Explorer - old - Login', font=('Eras Bold ITC', main_window2.calc_width(35), 'bold'), fg='gray20', bg=label_bg_color)  # fg='goldenrod2'
    main_title.place(x=main_window2.calc_width(180), y=main_window2.calc_height(25))  # (x=180, y=25)

    email_title = tkinter.Label(login_frame, text='Email:', font=('Eras Bold ITC', main_window2.calc_width(20), 'bold'), fg='gray20', bg='white').place(x=main_window2.calc_width(255), y=main_window2.calc_height(35))  # (x=255, y=35)
    enter_email = tkinter.Entry(login_frame, font=('Eras Bold ITC', main_window2.calc_width(15)), fg='gray20', bg='white', justify='center')
    ...
    password_title = tkinter.Label(login_frame, text='Password:', font=('Eras Bold ITC', main_window2.calc_width(20), 'bold'), fg='gray20', bg='white').place(x=main_window2.calc_width(225), y=main_window2.calc_height(140))  # (x=225, y=140)
    enter_password = tkinter.Entry(login_frame, font=('Eras Bold ITC', main_window2.calc_width(15)), fg='gray20', bg='white', justify='center', show='•')
    ...
    login_button = tkinter.Button(login_frame, text='Login', cursor='hand2', font=('Eras Bold ITC', main_window2.calc_width(15)), fg='gray20', bg=buttons_bg_color, command=submit)
    ...
    register_button = tkinter.Button(login_frame, text="Create a new account", cursor='hand2', bd=0, font=('Eras Bold ITC', main_window2.calc_width(10)), fg='gray20', bg=buttons_bg_color, command=register)
    ...
    forgot_button = tkinter.Button(login_frame, text='Reset your password', cursor='hand2', bd=0, font=('Eras Bold ITC', main_window2.calc_width(10)), fg='gray20', bg=buttons_bg_color, command=forgot_pass)
...
def start_register_window(main_frame):
    ...
    root.title('Remote File Explorer - old - Register')
    def submit():
        global email, ip_dict
        email_error_title.place_forget()
        pass_error_title.place_forget()
    ...
    email_error_title = tkinter.Label(register_frame, text='Please enter your email', font=('Eras Bold ITC', main_window2.calc_width(10)), fg='red', bg='white')
    email_error_title.place(x=main_window2.calc_width(55), y=main_window2.calc_height(85), width=main_window2.calc_width(500))  # (x=55, y=85, width=500)
    pass_error_title = tkinter.Label(register_frame, text='Please enter a password', font=('Eras Bold ITC', main_window2.calc_width(10)), fg='red', bg='white')
    pass_error_title.place(x=main_window2.calc_width(55), y=main_window2.calc_height(180), width=main_window2.calc_width(500))  # (x=55, y=180, width=500)
    re_pass_error_title = tkinter.Label(register_frame, text='Please Retype the password', font=('Eras Bold ITC', main_window2.calc_width(10)), fg='red', bg='white')
    re_pass_error_title.place(x=main_window2.calc_width(55), y=main_window2.calc_height(275), width=main_window2.calc_width(500))  # (x=55, y=275, width=500)
    email_error_title.place_forget()
    pass_error_title.place_forget()
    re_pass_error_title.place_forget()

    main_title = tkinter.Label(root, text='Remote File Explorer - old - Register', font=('Eras Bold ITC', main_window2.calc_width(35), 'bold'), fg='gray20', bg=label_bg_color)  # fg='goldenrod2'
    main_title.place(x=main_window2.calc_width(150), y=main_window2.calc_height(25))  # (x=150, y=25)

    email_title = tkinter.Label(register_frame, text='Email:', font=('Eras Bold ITC', main_window2.calc_width(20), 'bold'), fg='gray20', bg='white').place(x=main_window2.calc_width(255), y=main_window2.calc_height(10))  # (x=255, y=10)
    enter_email = tkinter.Entry(register_frame, font=('Eras Bold ITC', main_window2.calc_width(15)), fg='gray20', bg='white', justify='center')
    ...
    password_title = tkinter.Label(register_frame, text='Password:', font=('Eras Bold ITC', main_window2.calc_width(20), 'bold'), fg='gray20', bg='white').place(x=main_window2.calc_width(225), y=main_window2.calc_height(105))  # (x=225, y=105)
    enter_password = tkinter.Entry(register_frame, font=('Eras Bold ITC', main_window2.calc_width(15)), fg='gray20', bg='white', justify='center', show="•")
    ...
    re_password_title = tkinter.Label(register_frame, text='Retype Password:', font=('Eras Bold ITC', main_window2.calc_width(20), 'bold'), fg='gray20', bg='white').place(x=main_window2.calc_width(180), y=main_window2.calc_height(200))  # (x=180, y=200)
    re_enter_password = tkinter.Entry(register_frame, font=('Eras Bold ITC', main_window2.calc_width(15)), fg='gray20', bg='white', justify='center', show="•")
    ...
    register_button = tkinter.Button(register_frame, text='Register', cursor='hand2', font=('Eras Bold ITC', main_window2.calc_width(15)), fg='gray20', bg=buttons_bg_color, command=submit)
    ...
    login_button = tkinter.Button(register_frame, text="Login to your account", cursor='hand2', bd=0, font=('Eras Bold ITC', main_window2.calc_width(10)), fg='gray20', bg=buttons_bg_color, command=login)
...
def start_forgot_window(main_frame):
    ...
    root.title('Remote File Explorer - old - Reset Password')
    def submit():
        global email
        email_error_title.place_forget()
        # while True:
        if enter_email.get() == '':
            ...
            if manageSERVER.generate_and_send_reset_code(email):
                ...
                email_error_title.place(x=main_window2.calc_width(305), y=main_window2.calc_height(225), width=main_window2.calc_width(610), anchor=tkinter.CENTER)
            else:
    ...
    def new_pass_code():
        ...
        def key_entered(key):
            ...
            if password1 != password2:
                re_pass_error_title.configure(text="The passwords don't match")
                re_pass_error_title.place(x=main_window2.calc_width(305), y=main_window2.calc_height(338), width=main_window2.calc_width(610), anchor=tkinter.CENTER)
        ...
        reset_code_title = tkinter.Label(enter_code_frame, text='Reset Code:',
                                         ...
                                         bg='white').place(x=main_window2.calc_width(305), y=main_window2.calc_height(20), width=main_window2.calc_width(300), anchor=tkinter.CENTER)
        enter_reset_code = tkinter.Entry(enter_code_frame, font=('Eras Bold ITC', main_window2.calc_width(15)),
                                         fg='gray20',
                                         bg='white', justify='center')
        enter_reset_code.place(x=main_window2.calc_width(305), y=main_window2.calc_height(57), width=main_window2.calc_width(300), height=main_window2.calc_height(35), anchor=tkinter.CENTER)
        ...
        enter_email = tkinter.Entry(enter_code_frame, font=('Eras Bold ITC', main_window2.calc_width(15)), fg='gray20',
                                    bg='white', justify='center')
        ...
        enter_password = tkinter.Entry(enter_code_frame, font=('Eras Bold ITC', main_window2.calc_width(15)), fg='gray20',
        ...
        re_enter_password = tkinter.Entry(enter_code_frame, font=('Eras Bold ITC', main_window2.calc_width(15)),
        ...
        reset_code_error_title = tkinter.Label(enter_code_frame, text='Please enter the code you received in the email', font=('Eras Bold ITC', main_window2.calc_width(10)), fg='red', bg='white')
        email_error_title = tkinter.Label(enter_code_frame, text='Please enter your email', font=('Eras Bold ITC', main_window2.calc_width(10)), fg='red', bg='white')
        pass_error_title = tkinter.Label(enter_code_frame, text='Please enter a password', font=('Eras Bold ITC', main_window2.calc_width(10)), fg='red', bg='white')
        re_pass_error_title = tkinter.Label(enter_code_frame, text='Please Retype the password', font=('Eras Bold ITC', main_window2.calc_width(10)), fg='red', bg='white')
            ...
            if reset_pass_bttn['text'] == 'Reset Password':
                if enter_reset_code.get() == '' or enter_email.get() == '' or enter_password.get() == '' or re_enter_password.get() == '':
                    if enter_reset_code.get() == '':
                        reset_code_error_title.place(x=main_window2.calc_width(305), y=main_window2.calc_height(83), width=main_window2.calc_width(610), height=main_window2.calc_height(16), anchor=tkinter.CENTER)

                    if enter_email.get() == '':
                        email_error_title.configure(text='Please enter your email')
                        email_error_title.place(x=main_window2.calc_width(305), y=main_window2.calc_height(167), width=main_window2.calc_width(610), height=main_window2.calc_height(16), anchor=tkinter.CENTER)

                    if enter_password.get() == '':
                        pass_error_title.place(x=main_window2.calc_width(305), y=main_window2.calc_height(252), width=main_window2.calc_width(610), anchor=tkinter.CENTER)  # (x=55, y=180, width=500)
                    ...
                    email_error_title.place(x=main_window2.calc_width(305), y=main_window2.calc_height(167), width=main_window2.calc_width(610), height=main_window2.calc_height(8), anchor=tkinter.CENTER)
                    # break
                else:
                    email = enter_email.get()
    ...
    email_error_title = tkinter.Label(reset_frame, text='Please enter your email', font=('Eras Bold ITC', main_window2.calc_width(10)), fg='red', bg='white')
    email_error_title.place(x=main_window2.calc_width(55), y=main_window2.calc_height(205), width=main_window2.calc_width(500))  # (x=55, y=205, width=500)
    email_error_title.place_forget()

    main_title = tkinter.Label(main_frame, text='Remote File Explorer - old - Reset Password', font=('Eras Bold ITC', main_window2.calc_width(35), 'bold'), fg='gray20', bg=label_bg_color)  # fg='goldenrod2'
    main_title.place(x=main_window2.calc_width(59), y=main_window2.calc_height(25))  # (x=59, y=25)

    email_title = tkinter.Label(reset_frame, text='Email:', font=('Eras Bold ITC', main_window2.calc_width(20), 'bold'), fg='gray20', bg='white').place(x=main_window2.calc_width(255), y=main_window2.calc_height(130))  # (x=255, y=130)
    enter_email = tkinter.Entry(reset_frame, font=('Eras Bold ITC', main_window2.calc_width(15)), fg='gray20', bg='white', justify='center')
    ...
    email_title = tkinter.Label(reset_frame, text='already got an email?', font=('Eras Bold ITC', main_window2.calc_width(12)), fg='gray20', bg='white').place(x=main_window2.calc_width(120), y=main_window2.calc_height(15))
    enter_reset_code_bttn = tkinter.Button(reset_frame, text='Enter reset code', cursor='hand2', font=('Eras Bold ITC', main_window2.calc_width(12)), fg='gray20', bg=buttons_bg_color, command=new_pass_code)
    ...
    send_email_button = tkinter.Button(reset_frame, text='Send Email', cursor='hand2', font=('Eras Bold ITC', main_window2.calc_width(15)), fg='gray20', bg=buttons_bg_color, command=submit)
    ...
    login_button = tkinter.Button(reset_frame, text="Login to your account", cursor='hand2', bd=0, font=('Eras Bold ITC', main_window2.calc_width(10)), fg='gray20', bg=buttons_bg_color, command=login)
...
def server_status(main_frame):
    ...
    if status != 'SERVER IS UP':
        ...
        error_label = tkinter.Label(error_frame, text='error', bg='white', font=('Arial', main_window2.calc_width(17), 'bold'))
        if status == 'SERVER IS DOWN':
            ...
            # error_label.place(x=main_window.calc_width(225), y=main_window.calc_height(140))
        error_label.place(x=main_window2.calc_width(305), y=main_window2.calc_height(170), width=main_window2.calc_width(610), anchor=tkinter.CENTER)
...
def choose_mode_window(email):
    ...
    if email != None:
        ...
        root.title('Remote File Explorer - old')
