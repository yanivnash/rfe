...
# cur_path = r'C:\Users\yaniv\Desktop\Remote File Explorer - old'
cur_path = 'C:\\'
...
def create_bttn(frame):
    ...
    clm = 0
    rw = 2
    # os.chdir(r'D:\PycharmProjects\School\Remote File Explorer - old\GUI\files icons')
    ...
    for item in items_list:
        ...
        # photo = ImageTk.PhotoImage(Image.open(r'D:\PycharmProjects\School\Remote File Explorer - old\GUI\files icons\.dir_folder.png').resize((61, 50), Image.ANTIALIAS))
